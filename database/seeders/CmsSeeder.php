    ...
    public function run(): void
    {
        ...
        $posts = [
            ...
            [
                ...
                'content' => 'Starting January 2026, we officially opened the Surabaya branch office. This decision comes from rising support demand in East Java and our commitment to deliver service that is closer, faster, and consistent.
                With a local team, customers do not need to wait for visits from other cities for onboarding, workshops, or process optimization discussions. The goal is simple: reduce friction, speed adoption, and ensure a clean implementation from day one.
                ...
                We target faster response for time-sensitive needs such as configuration changes that block workflows or training needs when admin roles change. A local team also helps keep customer documentation consistent and easy to audit.
                <h3>Next steps</h3>
                ...
                Please contact the support team to schedule sessions. We will also announce monthly workshops that customers can join for free.
                Thank you for your trust. We grow with your needs, and Surabaya is an important step to deliver service that is closer and more impactful.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Year 2025 was a consolidation year: we strengthened service stability and built more disciplined operational habits. The focus was not only to add features, but to ensure existing capabilities run more reliably and are easier to monitor.
                ...
                We adopted simple but impactful routines: weekly service metric reviews, runbook updates, and data-driven improvement prioritization. This helps recurring issues get solved at the root rather than with quick patches.
                ...
                We will continue to share updates so customers can follow our service improvements and reliability work.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Wider digital access brings two sides: productivity opportunities and security risks. Through our CSR program, we provide digital literacy training for local communities so technology use becomes safer and more useful.
                <h3>Why digital literacy matters</h3>
                Many security incidents start from simple issues such as scam links, weak credentials, or careless data sharing. At the same time, many people do not yet use digital tools to save time, organize documents, and collaborate effectively.
                ...
                Sessions are short, hands-on, and case-based. Participants practice enabling multi-factor authentication, organizing folders, and spotting common scam patterns.
                ...
                We believe the best contribution is consistent. This program will continue regularly and materials will be updated with new risk patterns in the field.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Choosing the right package makes implementation smoother and costs more efficient. Below is a practical guide to understand the differences between Basic, Pro, and Enterprise and when to upgrade.
                ...
                If your team is small and processes are simple, Basic is usually enough. When approvals grow, multiple units are involved, or documents go through many revisions, Pro becomes more valuable because automation and reporting are stronger.
                <h4>2) Access control and compliance</h4>
                Organizations that need audit trails, granular access policies, and compliance requirements usually fit Enterprise. It helps ensure every change is traceable and access does not exceed authority.
                <h4>3) Reporting and insights</h4>
                If you need routine reports for management or want to monitor bottlenecks, Pro and Enterprise offer stronger dashboards and export options.
                ...
                If you want, our team can run a short assessment to map needs and recommend the most efficient package.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Connect the product with ERP, CRM, HRIS, or internal portals through APIs to automate approvals, sync master data, and trigger notifications. Start with one critical flow, test in staging, then roll out gradually while monitoring error rate and latency.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'KPI dashboards help teams monitor process health without opening each item. With the right KPIs, you can see bottlenecks, prioritize improvements, and report progress to stakeholders clearly.
                <h3>Common KPIs</h3>
            ...
            [
                ...
                'content' => 'Observability is the ability to understand internal system conditions from the signals the system produces. It is more than monitoring; observability helps explain why an issue happened, not only that it happened.
            ...
            [
                ...
                'content' => 'Event-driven architecture (EDA) publishes important state changes as events, and other services react to those events. It works well for long, multi-stage, and cross-system workflows.
            ...
            [
                ...
                'content' => 'Caching stores frequently accessed data or computed results so later requests return faster. Poor caching can cause stale data or hard-to-trace bugs, so strategy matters.
            ...
            [
                ...
                'content' => 'RICE (Reach, Impact, Confidence, Effort) helps teams compare initiatives with a consistent scoring method. Define reach and impact, set confidence, estimate effort, then review results together to make trade-offs transparent.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'CAC measures the cost to acquire a customer, while LTV measures the value you earn over the customer lifetime. Track both to judge channel efficiency, retention health, and how much you can invest in growth.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'A strong B2B go-to-market plan starts with the right ICP, clear positioning, and a focused channel strategy. Build feedback loops from sales and onboarding so messaging and product keep improving.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Our culture is built on fast execution without shortcuts, tidy processes that are easy to audit, and transparent communication that keeps teams aligned. We value clarity, feedback, and measurable impact.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'The 2026 internship program offers real project work with mentors and clear goals. Participants learn end-to-end delivery, from understanding the problem to presenting results.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'We look for structured thinking, clear communication, and the ability to execute. Bring real examples, explain your decisions, and show how you learn from results.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Practical webinar on templates, approvals, and reporting for operations teams.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Meetup focused on observability, tracing, and scaling patterns that teams can apply to improve reliability.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Roadshow training for admins to strengthen access control and audit readiness.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'The audit trail release records who changed what and when, making reviews and investigations faster.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Real-time notifications alert approvers on new requests, revisions, and status changes to reduce waiting time.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Export to CSV and Excel makes it easier to analyze reports and share periodic updates with stakeholders.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Start with key document types, define required sections, and add a short completeness checklist.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Map roles by function, apply least privilege, and review access regularly to keep workflows secure.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Review cycle time, rework rate, and WIP trends to spot bottlenecks, then prioritize small fixes.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Enable MFA for admins and approvers to reduce the risk of account takeover and unauthorized access.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Rotate API keys regularly, limit scope, and store secrets in a secure vault to reduce exposure.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Submit vulnerabilities with clear steps and impact so we can triage, fix, and communicate updates quickly.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Define RPO and RTO, automate backups, and test recovery regularly to keep services resilient.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Start with query and index tuning, add caching and read replicas, then consider partitioning or sharding when data grows.',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Prepare CI/CD and observability, migrate non-critical services first, then scale the approach to core workloads.',
                'status' => 'published',
        ...
        foreach ($posts as $postData) {
            ...
            $post->update([
                'featured_image' => "blogs/{$post->id}/image1.png",
            ]);
