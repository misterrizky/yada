...
<x-app.modal.form
    name="form-country"
    :title="$countryId ? 'Edit Country' : 'New Country'"
    :subheading="$countryId ? 'update country information below.' : 'Add new countries to the system.'"
    submit="save"
    close="resetModal"
>
    <div class="grid grid-cols-1 gap-4 md:grid-cols-12">
        ...
        <div class="md:col-span-4">
            <flux:input
                ...
                autocomplete="off"
            />
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Without “+”. Eg: 62</p>
        </div>
    </div>
